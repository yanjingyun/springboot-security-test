...
/**
 * OAuth2的授权服务器配置类
 * 注：继承AuthorizationServerConfigurerAdapter类，并使用@Configuration和@EnableAuthorizationServer注解
 */
@Configuration
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	// 注入 WebSecurityConfiguration 中配置的 AuthenticationManager
	@Autowired
